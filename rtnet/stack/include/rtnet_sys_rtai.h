 ...
 *          RTOS abstraction layer - RTAI/classic version
 *
...
/* RT-tasks */
#define RTOS_LOWEST_RT_PRIORITY     RT_SCHED_HIGHEST_PRIORITY
#define RTOS_HIGHEST_RT_PRIORITY    RT_SCHED_LOWEST_PRIORITY
