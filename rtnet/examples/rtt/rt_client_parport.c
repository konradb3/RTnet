/***
 *
 *  examples/rtt/rt_client_parport.c
 *
 ...
 *  support for 'Latency Measurement Gadget'
 *	(http://www.selfnet.uni-stuttgart.de/~bocki/Stuff/Impulsgeber/)
 *	added by Jan Kiszka
 *
...
static int cycle = 10*1000; // = 10 ms
...
MODULE_PARM_DESC (cycle, "cycletime in us (note: only 10000, 1000, 100, 10 us are supported)");
